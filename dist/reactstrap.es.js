...
var Dropdown = function (_React$Component) {
    ...
    createClass(Dropdown, [{
        ...
        value: function handleDocumentClick(e) {
            ...
            var indirectContainer = this.props.getContainer ? this.props.getContainer() : null;

            if ((indirectContainer && indirectContainer.contains(e.target) || container.contains(e.target)) && container !== e.target && (e.type !== 'keyup' || e.which === keyCodes.tab)) {
                return;
            }
        ...
        value: function render() {
            ...
            var _omit = omit(this.props, ['toggle', 'disabled', 'getContainer']),
      ...
      return React.createElement(
        ...
        function (status) {
          ...
          return React.createElement(
            ...
            React.createElement(Tag, { className: imgClasses, src: src, alt: altText }),
            children
          );
        }
      );
